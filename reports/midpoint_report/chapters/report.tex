...
\fancypagestyle{noheadrule}{
    ...
    \fancyfoot[L,LO]{\textit {FINAL PROJECT}}
...
\fancyfoot[L,LO]{\textit {FINAL PROJECT REPORT}} 
\fancyfoot[R,RO]{\bfseries\thepage}
...
% Phase 1
\input{midpoint_report/chapters/objectives}
\input{chapters/simulation_overview}
% \input{chapters/communication}
\input{chapters/object_detection}
\input{chapters/localisation}
% Phase 2
\input{chapters/formation}
% SLAM chapter
% Hardware chapter
% Simulation Overview chapter
