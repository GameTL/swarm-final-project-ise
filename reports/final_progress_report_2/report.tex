...
\fancypagestyle{noheadrule}{
    ...
    \fancyfoot[L,LO]{\textit {PROGRESS REPORT II}}
...
\fancyfoot[L,LO]{\textit {PROGRESS REPORT II}} \fancyfoot[RE,RO]{\bfseries\thepage}
...
\input{chapters/path_planning}
% \input{chapters/slam}
% \input{chapters/odometry}
\input{chapters/hardware}
% \input{chapters/coordination}
% \input{chapters/object_detection}
\input{chapters/odometry}
\input{chapters/future_software_plans}
